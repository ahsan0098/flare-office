                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ route('employeDashboard') }}" class="nav-link active">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview ml-2">
                                <li class="nav-item">
                                    <a href="{{ route('employe-chatroom') }}" class="nav-link">
                                        <i class="bi bi-shield-lock-fill nav-icon"></i>
                                        <p>Pivate chat</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('employe-public-chatroom') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('employe-attendance') }}" class="nav-link">
