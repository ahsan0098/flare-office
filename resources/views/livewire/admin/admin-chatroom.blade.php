<div>
    <div class="row m-0 p-0">
        {{-- @php
            ...
            print_r($chat);
        @endphp --}}
        <section class="col-lg-7 connectedSortable" wire:poll="refreshing">
            {{-- @php
                echo '<pre>';
                print_r($test);
            @endphp --}}
                                        ...
                                        <div>
                                            @if ($ct['sender']['id'] == $me)
                                                <div class="direct-chat-msg right">
                                                    ...
                                                    <!-- /.direct-chat-infos -->
                                                    <img class="direct-chat-img" src="{{ $ct['sender']['image'] }}"
                                                        alt="">
                                                    <!-- /.direct-chat-img -->
                            ...
                            @foreach ($users as $user)
                                <li>
                                    <a href="#" data-widget="chat-pane-toggle"
                                        ...
                                        <img class="contacts-list-img" src="{{ $user->image }}" alt="no image">
                                        ...
                                        <div class="contacts-list-info">
                                            ...
                                            <span class="contacts-list-msg">{{ $test }}</span>
                                        </div>
                                        <!-- /.contacts-list-info -->
                                    </a>
                                </li>
