                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <h5 class="my-3"><?php echo e(Str::ucfirst($user->name)); ?></h5>

                            <p class="text-muted mb-1"><?php echo e(Str::ucfirst($user->position->name)); ?> from the department of
                                <?php echo e(Str::ucfirst($user->department->name)); ?></p>
    ...
    <div class="row">
        <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="<?php echo e(asset('storage/employe_' . $user->id)); ?>/<?php echo e($file); ?>"
...
<?php /**PATH C:\xampp\htdocs\flare-office\resources\views/livewire/admin/admin-profile-component.blade.php ENDPATH**/ ?>