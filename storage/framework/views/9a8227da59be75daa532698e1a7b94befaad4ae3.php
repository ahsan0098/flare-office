                                ...
                                <div>
                                    <?php if($public['sender']['id'] == $me): ?>
                                        <div class="direct-chat-msg right my-1 py-1">
                                            ...
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text bg-success border-0 py-3">
                                    ...
                                    <?php else: ?>
                                        <div class="direct-chat-msg my-1 py-1">
                                            ...
                                            <img class="direct-chat-img"
                                                src="<?php echo e(asset('storage/employe_' . $public['sender']['id'])); ?>/<?php echo e($public['sender']['image']); ?>">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text bg-primary py-3">
                                                <?php echo e($public['message']); ?>
...
<!-- /.col -->
<?php /**PATH C:\xampp\htdocs\flare-office\resources\views/livewire/employe/employe-public-chat.blade.php ENDPATH**/ ?>