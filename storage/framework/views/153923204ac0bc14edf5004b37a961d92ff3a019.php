    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <!-- Left col -->
                <?php
                    $color = ['bg-success', 'bg-primary', 'bg-warning', 'bg-info', 'bg-danger'];
                    // $i = array_rand($color, 1);
                ?>
                <?php if(is_array($dep) || is_object($dep)): ?>
                    <?php $__currentLoopData = $dep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-<?php echo e(rand(5, 6)); ?>">
                            <!-- MAP & BOX PANE -->
                            <?php
                                $i = array_rand($color, 1);
                            ?>
                            <div class="card">
                                <div class="card-header <?php echo e($color[$i]); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="" method="POST" wire:submit.prevent="addSubDepartment" id="sub_dept_form">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Name</label>
                                    <input type="text" name="sub_name" class="form-control" id="exampleInputEmail1"
                                        placeholder="Enter sub-deparment name" name="sub_name" wire:model="sub_name">
